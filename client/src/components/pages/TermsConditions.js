...
const TermsConditions = () => {
  return (
    <div>
      ...
      <p>Welcome to AutoMarket!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of AutoMarket's Website, located at
      ...
      <p>
        We employ the use of cookies. By accessing AutoMarket, you agreed to use
        cookies in agreement with the AutoMarket's Privacy Policy.
      </p>
      ...
      <p>
        ...
        AutoMarket does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of AutoMarket,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, AutoMarket shall not be
      ...
      <p>
        AutoMarket reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant AutoMarket a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of AutoMarket; and (d) the link is
      ...
      <p>
        ...
        e-mail to AutoMarket. Please include your name, your organization name,
      ...
      <p>
        No use of AutoMarket's logo or other artwork will be allowed for linking
